...
public class Util {
    ...
    public static int getDuration(int start, int velocity) {
        final int delta = start - 0;
        return (int) (1000.0 * Math.sqrt(-2.0 * delta / getDeceleration(delta))) + Math.abs(velocity) / 10;
    }
