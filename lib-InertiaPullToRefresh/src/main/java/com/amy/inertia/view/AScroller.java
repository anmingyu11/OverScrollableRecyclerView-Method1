...
final class AScroller {
    ...
    public void attachAScrollerController(AScrollerController aScrollerController) {
     ...
     */
    public int[] notifyVerticalEdgeReached(int startY, int finalY, int overY) {
        return mScrollerY.notifyEdgeReached(startY, finalY, overY);
    }
    ...
    int getSpringBackDuration() {
        return mScrollerY.getSpringBackDuration();
    }

    int getBallisticDistance() {
        return mScrollerY.ballisticDistance;
    }

    int getRawCurrVelocity() {
        return (int) mScrollerY.mCurrVelocity;
    }

    int getRawVelocity() {
        return mScrollerY.mVelocity;
    }
    ...
    static class SplineOverScroller {
        ...
        private void startSpringback(int start, int end, int velocity) {
            ...
            springBackDuration = mDuration;
            LogUtil.d("over：" + mOver + " duration : " + mDuration);
        }
        ...
        private int[] startAfterEdge(int start, int min, int max, int velocity) {
            ...
            if (keepIncreasing) {
                ...
                return startBounceAfterEdge(start, edge, velocity);
            } else {
        ...
        private int[] startBounceAfterEdge(int start, int end, int velocity) {
            mDeceleration = getDeceleration(velocity == 0 ? start - end : velocity);
            fitOnBounceCurve(start, end, velocity);
            return onEdgeReached();
        }

        private int ballisticDistance;

        int[] notifyEdgeReached(int start, int end, int over) {
            ...
            if (mState == SPLINE) {
                ...
                return startAfterEdge(start, end, end, (int) mCurrVelocity);
            }
            return null;
        }

        private int[] onEdgeReached() {
            ...
            LogUtil.d("overFling distance : " + distance);
            LogUtil.d("duration : " + mDuration);
            return new int[]{(int) distance, mDuration};
        ...
        boolean update() {
            ...
            switch (mState) {
                ...
                case BALLISTIC: {
                    ...
                    ballisticDistance = (int) distance;
                    LogUtil.d("ballistic distance :  " + distance);
                    break;
                }
